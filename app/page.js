      ...
      <div className="max-w-lg mx-auto p-4">
        ...
        <div className="mt-6 bg-stone-50 border border-stone-200 rounded-lg p-3">
          ...
          <p className="text-[11px] text-stone-500">
            Kamu juga bisa membuka, mengubah, atau menghapus data apa pun langsung dari database di Supabase Dashboard → <strong>Table Editor</strong>. Di sana semua tabel (items, transaksi, kategori, jenis_barang) bisa dilihat dan diedit baris per baris seperti spreadsheet.
          </p>
        </div>
      </div>
